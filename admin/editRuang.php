...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mt-5 text-gray-800 ">Edit Data Ruang</h1>
    </div>
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header d-sm-flex align-items-center justify-content-between">
                    <a href="ruang.php" class="d-none d-sm-inline-block btn btn-sm"><i
                ...
                <div class="card-body">
                    <form class="user" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="kapasitasRuang" name="kapasitasRuang"
                                required>
                        </div>
                </div>
                <div class="modal-footer">
                    <button type="reset" class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                    <button type="submit" name="editRuang" class="btn btn-success">Edit</button>
                </div>
                </form>
            </div>
        </div>
