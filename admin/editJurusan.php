...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mt-5 text-gray-800 ">Edit Data Jurusan</h1>
    </div>
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header d-sm-flex align-items-center justify-content-between">
                    <a href="jurusan.php" class="d-none d-sm-inline-block btn btn-sm"><i
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="editJurusan" class="btn btn-success">Edit</button>
                </div>
                </form>
            </div>
        </div>
