...
<div class="container-fluid">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mt-5 text-gray-800 ">Data Kehadiran</h1>
  </div>
    ...
    <div class="col-md-12">
      <div class="card mb-4">
        <div class="card-header d-sm-flex align-items-center justify-content-between">
          <h6 class="text-custom font-weight-bold">Import Kehadiran</h6>
          <a href="importKehadiran.php" class="d-none d-sm-inline-block btn btn-primary btn-sm shadow-sm"><i class="fas fa-file-import fa-sm text-white-50"></i> Import Kehadiran</a>
        </div>
        <div class="card-body">
