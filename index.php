...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-5">
                <img class="gambar" src="images/banner.svg" style="width:30em;">
            </div>
        </div>
    </div>
</div>
<hr>
<div class="container">
    <h1 class="judul text-center mt-5">Program Kerja</h1>
    <p class="font-weight-light text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. <br> Atque a repellat dolorem quidem autem modi neque quod nisi.</p>
    <div class="row mb-5 mt-5 align-items-center justify-content-center">
        <div class="col-lg-3 mr-5">
            <div class="card text-center" style="width: 18rem;">
                <div class="card-body">
                    <img class="mb-3 mt-3" src="images/pendataan.svg" style="width:8em;">
                    <h4 class="judul-card">Pendataan</h4>
